...
if ( ! function_exists( 'cache_get' ) ) {
	function cache_get( $cid, $table = 'cache' ) {
		return \Ah\Cms\Cache\CacheManager::get( $cid, $table );
	}
}

if ( ! function_exists( 'cache_set' ) ) {
	function cache_set( $cid, $data, $table = 'cache', $expire = CACHE_PERMANENT, $headers = null ) {
		return \Ah\Cms\Cache\CacheManager::set( $cid, $data, $table, $expire, $headers );
	}
}

if ( ! function_exists( 'cache_clear_all' ) ) {
	function cache_clear_all( $cid = null, $table = null, $wildcard = false ) {
		return \Ah\Cms\Cache\CacheManager::clear_all( $cid, $table, $wildcard );
	}
}

if ( ! function_exists( 'cache_key_gen' ) ) {
	function cache_key_gen( ...$args ) {
		return \Ah\Cms\Cache\CacheManager::key_gen( ...$args );
	}
}
