...
<?php \Ah\Cms\Admin\Components\AdminComponents::pageHeader( 'randomize', 'Redirect Rules', 'Short links and redirects with click tracking.' ); ?>

<?php if ( $nm ) : ?>
<?php \Ah\Cms\Admin\Components\AdminComponents::notice( esc_html( $nm ), $nt === 'error' ? 'warning' : 'success' ); ?>
<?php endif; ?>
			...
			<tr style="border-top:1px solid var(--ah-border);<?php echo ! $r->is_active ? 'opacity:.4;' : ''; ?>">
				...
				<td style="padding:12px 14px;">
					<div style="display:flex;gap:4px;flex-wrap:wrap;justify-content:flex-end;">
						...
						<?php endif; ?>
						<form method="post" style="display:inline;"
						      class="ah-confirm-delete" data-title="Delete Link" data-confirm="Delete this short link?">
							<?php wp_nonce_field( 'ah_redirect_action', 'ah_redirect_nonce' ); ?>
