 ...
 * Expects $c (the current card array) to be in scope.
 */
defined( 'ABSPATH' ) || exit;

if ( empty( $c['channel'] ) && empty( $c['avatar'] ) ) return;
?>
<span class="pt-mvs-channel">
	<?php if ( ! empty( $c['avatar'] ) ) : ?>
		<img class="pt-mvs-avatar" src="<?php echo esc_url( $c['avatar'] ); ?>" alt="" loading="lazy">
	<?php endif; ?>
	<span class="pt-mvs-channel-text">
