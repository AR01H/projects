...
$tagline = (string) ( $tagline ?? 'Freshly Pressed. Naturally Refreshing. Always Made With Care.' );
$year    = gmdate( 'Y' );
?>
		...
		<div class="site-footer__grid">
			...
			<div class="site-footer__col site-footer__col--brand">
				...
				<div class="site-footer__social-list">
					<a class="site-footer__social-btn" href="https://instagram.com/thecanehouseuk" target="_blank" rel="noopener" aria-label="Instagram">
					...
					<a class="site-footer__social-btn" href="https://facebook.com/thecanehouseuk" target="_blank" rel="noopener" aria-label="Facebook">
					...
					<a class="site-footer__social-btn" href="https://wa.me/447770461999" target="_blank" rel="noopener" aria-label="WhatsApp">
			...
			<div class="site-footer__col">
				...
				<ul class="site-footer__links">
					...
					<li><a href="<?php echo esc_url( home_url( '/all-about-cane' ) ); ?>">All About Cane</a></li>
					<li><a href="<?php echo esc_url( home_url( '/history' ) ); ?>">Our Heritage</a></li>
			...
			<div class="site-footer__col site-footer__col--contact">
				...
				<div class="site-footer__contact-items">
					<a class="site-footer__contact-row" href="tel:+447770461999">
