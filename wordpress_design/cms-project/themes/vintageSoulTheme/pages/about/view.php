...
<div class="about-page">
	...
	<header class="about-hero">
		<div class="container about-hero__inner">
			...
			<p class="about-hero__tag">The Cane House Story</p>
			<p class="about-hero__sub">We are on a mission to bring the authentic, traditional sugarcane juice experience back to modern communities — freshly pressed, 100% natural, and full of memories.</p>
		</div>
	</header>
	...
	<section class="section about-intro-section">
		<div class="container container--narrow about-intro__container">
			<h2 class="about-section-title">MORE THAN JUST A CROP</h2>
	...
	<section class="section section--dark-botanical about-pillars-section">
		<div class="container">
			<div class="section-header">
				<h2 class="section-header__title">FOUR PILLARS OF OUR CRAFT</h2>
	...
	<!-- ═══════════ 7. MEET THE TEAM (Dark Botanical) ═══════════ -->
	<?php if ( ! empty( $team_members ) ) : ?>
		<section class="section section--dark-botanical about-team-section">
			<div class="container">
				<div class="section-header">
					<h2 class="section-header__title">MEET THE TEAM</h2>
					<p class="section-header__tag">The Hands Behind The Work</p>
				</div>
					...
					<?php foreach ( $team_members as $member ) : ?>
						<div class="team-card">
							<div class="team-card__photo">
								<img src="<?php echo esc_url( (string) ( $member['photo'] ?? '' ) ); ?>" alt="<?php echo esc_attr( (string) ( $member['name'] ?? '' ) ); ?>" loading="lazy">
							</div>
	...
	<section class="section about-cta-section">
		<div class="container container--narrow">
			<div class="back-home__box">
				<h3 class="back-home__title">WANT TO TASTE THE TRADITION?</h3>
