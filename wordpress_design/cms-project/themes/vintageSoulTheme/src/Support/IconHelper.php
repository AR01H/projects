...
class IconHelper {
	...
	public static function get( string $name, string $color = 'currentColor', int $size = 20 ): string {
		...
		$icons = array(
			...
			'shield-check' => '<svg class="vst-icon vst-icon--shield-check" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>',
			'utensils' => '<svg class="vst-icon vst-icon--utensils" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2v6a3 3 0 0 1-3 3 3 3 0 0 1-3-3V2M15 2v18M6 2v18M3 2v4a3 3 0 0 0 3 3h0a3 3 0 0 0 3-3V2"/></svg>',
			...
			'whatsapp' => '<svg class="vst-icon vst-icon--whatsapp" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21l1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"/><path d="M9.5 9a.5.5 0 0 0-.5.5c0 1.5 1 3.5 2.5 5s3.5 2.5 5 2.5a.5.5 0 0 0 .5-.5v-1.5a.5.5 0 0 0-.5-.5l-1.5-.3a.5.5 0 0 0-.5.2l-.7.7a6.5 6.5 0 0 1-3-3l.7-.7a.5.5 0 0 0 .2-.5l-.3-1.5a.5.5 0 0 0-.5-.5z"/></svg>',
			...
			'sun' => '<svg class="vst-icon vst-icon--sun" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>',
			'recycle' => '<svg class="vst-icon vst-icon--recycle" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 19 3 19 3 15"/><path d="M3 19 8.5 9.5a4 4 0 0 1 7 0L17 12"/><polyline points="17 5 21 5 21 9"/><path d="M21 5 18 10.5a4 4 0 0 1-7 0L9.5 8"/><polyline points="12 22 12 18 16 18"/><path d="M12 22 17.5 13a4 4 0 0 1 3.5 6H12"/></svg>',
			'tractor' => '<svg class="vst-icon vst-icon--tractor" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="m10 11 11 .9a1 1 0 0 1 .8 1.1l-.66 5a1 1 0 0 1-1 .9H2"/><path d="M16 18h-5"/><path d="M18 5a1 1 0 0 0-1 1v5"/><circle cx="7" cy="15" r="5"/><circle cx="18" cy="19" r="2"/></svg>',
			'sprout' => '<svg class="vst-icon vst-icon--sprout" width="' . $size . '" height="' . $size . '" viewBox="0 0 24 24" fill="none" stroke="' . $color . '" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-10"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4.1 5.5.8z"/><path d="M14.1 6a7 7 0 0 0-1.1 4c1.9-.1 3.3-.6 4.3-1.4 1-1 1.6-2.3 1.7-4.6-2.7.1-4.3 1.1-4.9 2z"/></svg>',
		);
