...
class CH_Data {
	...
	private static function default_faqs(): array {
		return [
			...
			[ 'topic' => 'Events',    'question' => 'How much does it cost to hire for an event?',              'answer' => 'Pricing is customised based on your event size location duration and number of guests. Contact us for a personalised quote.',                                                                                                         'status' => 'active', 'sort_order' => '5'  ],
	...
	private static function default_navigation(): array {
		return [
			...
			[ 'id' => 'contact-us',   'label' => 'Contact Us',   'url' => '#contact',       'visible' => 'true', 'is_cta' => 'true'  ],
		];
	}
