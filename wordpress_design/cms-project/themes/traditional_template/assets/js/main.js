...
(function () {
  ...
  function render(results) {
    ...
    results.forEach(function (item) {
      var link = NT.el("a", "app-search-result");
      link.href = item.url;
      link.appendChild(NT.el("span", "app-search-result-title", item.title));
      link.appendChild(
        NT.el("span", "app-search-result-meta", item.type + " - " + item.date),
      );
