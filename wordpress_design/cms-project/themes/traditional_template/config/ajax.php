 ...
 *      .then( function ( res ) { ... } );
 *   The helper adds the wp action name (app_contact_submit) and the per-action
...
return array(
	...
	'contact_submit' => array(
		'callback' => 'app_ajax_contact_submit',
	...
	'search_posts' => array(
		'callback' => 'app_ajax_search_posts',
	...
	'order_submit' => array(
		'callback' => 'app_ajax_order_submit',
