...
$data      = App_Data_Provider::get( $fb_source );
...
<section class="app-badges">
	<div class="container app-badges__inner">
		...
		?>
			<div class="app-badges__item">
				<?php if ( ! empty( $item['icon'] ) ) : ?>
					<span class="app-badges__icon" aria-hidden="true"><?php echo esc_html( $item['icon'] ); ?></span>
				<?php endif; ?>
				<span class="app-badges__label"><?php echo esc_html( $label ); ?></span>
				<?php if ( ! empty( $item['note'] ) ) : ?>
					<span class="app-badges__note"><?php echo esc_html( $item['note'] ); ?></span>
				<?php endif; ?>
			</div>
		<?php endforeach; ?>
	</div>
