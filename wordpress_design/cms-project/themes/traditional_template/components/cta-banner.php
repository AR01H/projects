...
?>
<section class="app-cta-band<?php echo $image ? ' app-cta-band--photo' : ''; ?>"
	<?php if ( $image ) : ?>style="background-image:url('<?php echo esc_url( $image ); ?>');"<?php endif; ?>>
	<?php if ( $image ) : ?><span class="app-cta-band__scrim" aria-hidden="true"></span><?php endif; ?>
	<div class="container app-cta-band__inner">
		<?php if ( $tag ) : ?><span class="app-cta-band__tag"><?php echo esc_html( $tag ); ?></span><?php endif; ?>
		<h2 class="app-cta-band__title"><?php echo wp_kses( $title, array( 'em' => array(), 'br' => array() ) ); ?></h2>
		<?php if ( $sub ) : ?><p class="app-cta-band__sub"><?php echo esc_html( $sub ); ?></p><?php endif; ?>

		<?php if ( ! empty( $buttons ) ) : ?>
			<div class="app-cta-band__actions">
