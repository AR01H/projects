...
<section class="app-values" id="values">
	...
	'body'  => $sub ?? ''
		...
		<div class="app-values__layout<?php echo $image ? ' app-values__layout--split' : ''; ?>">
			<div class="app-values__grid">
				...
				?>
					<article class="app-value">
						<?php if ( ! empty( $item['icon'] ) ) : ?>
							<span class="app-value__icon" aria-hidden="true"><?php echo esc_html( $item['icon'] ); ?></span>
						<?php endif; ?>
						<h3 class="app-value__title"><?php echo esc_html( $v_ttl ); ?></h3>
						<?php if ( ! empty( $item['text'] ) ) : ?>
							<p class="app-value__text"><?php echo esc_html( $item['text'] ); ?></p>
						<?php endif; ?>
					</article>
				<?php endforeach; ?>
			</div>
			...
			<?php if ( $image ) : ?>
				<figure class="app-values__media">
