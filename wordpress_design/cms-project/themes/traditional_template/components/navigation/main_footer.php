...
<footer class="<?php echo esc_attr( $footer_classes ); ?>" role="contentinfo"<?php echo $footer_style; ?>>
	...
	<!-- Decorative Corners -->
	<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/svg/decorations/corner-ornament.svg' ); ?>" class="app-footer__corner app-footer__corner--left" alt="" aria-hidden="true" />
	<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/svg/decorations/corner-ornament.svg' ); ?>" class="app-footer__corner app-footer__corner--right" alt="" aria-hidden="true" />
	...
	<div class="container">
		<div class="app-footer__inner">
				...
				<a href="<?php echo esc_url( home_url('/') ); ?>" class="app-footer__logo-link">
					...
					<?php else : ?>
						<div class="app-footer__brand-fallback">
							<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/svg/decorations/brand-star.svg' ); ?>" class="app-footer__brand-icon" alt="" aria-hidden="true" />
			...
			<div class="app-footer__col">
				...
				<?php if ( $nt_socials ) : ?>
					<div class="app-footer__social-list">
						<span class="app-footer__social-label"><?php echo esc_html( $lbl_connect ); ?></span>
						<div class="app-footer-social-media-icons">
							<?php foreach ( $nt_socials as $net => $url ) :
								...
								$icon_svg = '<img src="' . esc_url( get_template_directory_uri() . '/assets/svg/icons/' . $icon_file ) . '" alt="' . esc_attr( ucfirst( $net ) ) . '" width="22" height="22" />';
							?>
								<a class="app-footer__social" href="<?php echo esc_url($url); ?>" target="_blank" rel="noopener" aria-label="<?php echo esc_attr(ucfirst($net)); ?>">
									<?php echo $icon_svg; ?>
								</a>
							<?php endforeach; ?>
						</div>
