...
function ah_mock_faqs( string $topic = '' ): array {
	$all = [
		(object)[ 'id' => 1,  'topic' => 'General',  'question' => "What is a buyer's agent?",                             'answer' => "A buyer's agent works exclusively on behalf of the buyer - not the seller. Unlike an estate agent paid by the seller to achieve the highest price, we are paid by you to find the right property at the best possible price.",            'status' => 'active', 'sort_order' => 1 ],
