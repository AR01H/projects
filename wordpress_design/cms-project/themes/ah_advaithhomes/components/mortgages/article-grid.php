  ...
  <section class="nhp-articles">
    <div class="container">
      ...
      <div class="nhp-articles__grid">
        ...
        ?>
        <a href="<?php echo esc_url( $m['url'] ); ?>" class="nhp-article-card"
          ...
          <div class="nhp-article-card__img-wrap">
            <?php if ( $m['thumb'] ) : ?>
              <img src="<?php echo esc_url( $m['thumb'] ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" loading="lazy">
            <?php else : ?><div class="nhp-article-card__ph">💷</div><?php endif; ?>
            <?php if ( $m['cat'] ) : ?>
              <span class="nhp-pill nhp-pill--sm nhp-article-card__badge"><?php echo esc_html( $m['cat']->name ); ?></span>
            <?php endif; ?>
          </div>
