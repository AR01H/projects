...
?>
<section class="section section--pattern" aria-label="<?php echo esc_attr( TXT_CLIENT_TESTIMONIALS ); ?>">
  <div class="container">
    <div class="section__header text-center">
      ...
      <p class="section__desc" style="margin-inline:auto">
        Over <?php echo esc_html( $client_stat ); ?> buyers have trusted us to find and secure their home. Here's what they say.
      </p>
    </div>
    ...
    <div style="display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:40px">
      ...
      <span style="font-size:1.1rem;font-weight:600"><?php echo esc_html( $rating_num ); ?> / 5</span>
