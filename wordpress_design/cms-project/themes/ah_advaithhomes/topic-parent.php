<?php
/**
 * Template: Parent Term Archive
 * URL: /{parent-term-slug}/
...
// ── Parent term (set by template_include filter) ──────────────────────────────
$pt = $GLOBALS['ah_current_pt'] ?? null;
if ( ! $pt ) { wp_redirect( home_url( '/' ) ); exit; }

$pt_slug  = $pt->slug;
$pt_name  = $pt->name;
$pt_color = ! empty( $pt->color ) ? $pt->color : 'var(--accent)';
	...
	<div class="container">
		<div class="topic-filter-strip__inner">
			<a href="<?php echo esc_url( home_url( '/' . $pt_slug . '/' ) ); ?>"
			   class="topic-chip topic-chip--all topic-chip--active">
