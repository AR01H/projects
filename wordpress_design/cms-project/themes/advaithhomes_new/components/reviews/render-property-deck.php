 ...
 * short quote, name, result stat). Used standalone by
 ...
 * panel lives in components/sections/reviews_property_deck.php, since it
 * needs the whole group of property_deck reviews at once, not a single one -
 * this file is just what a single card looks like on its own.
 *
 * Theme-level override of plugins/cms-plugin/models/reviews/render-property-deck.php -
