 ...
 * components/sections/reviews_property_deck.php, since it needs the whole
 * group of property_deck reviews at once, not a single one - this file is
 * just what a single card looks like on its own.
 *
