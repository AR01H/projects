...
<aside class="contact-sidebar">
	...
	<div class="contact-alt-box contact-alt-wa">
		...
		<div class="contact-channel-list">
			<?php if ( '' !== $_wa_num ) : ?>
			<a href="<?php echo esc_url( $_wa_href ); ?>" class="contact-channel-item" target="_blank" rel="noopener noreferrer">
				<span class="contact-channel-meta">
					<span class="contact-channel-icon"><i class="fa-brands fa-whatsapp"></i></span>
				</span>
				<span class="contact-channel-num"><?php echo esc_html( $_wa_num ); ?></span>
			</a>
			<?php endif; ?>
			<?php if ( '' !== $_ph_num ) : ?>
			<a href="<?php echo esc_url( $_ph_href ); ?>" class="contact-channel-item">
				<span class="contact-channel-meta">
					<span class="contact-channel-icon"><i class="fa-solid fa-phone"></i></span>
				</span>
				<span class="contact-channel-num"><?php echo esc_html( $_ph_num ); ?></span>
			</a>
			<?php endif; ?>
			<?php if ( '' !== $_em_adr ) : ?>
			<a href="<?php echo esc_url( $_em_href ); ?>" class="contact-channel-item">
				...
				<span class="contact-channel-num contact-channel-email"><?php echo esc_html( $_em_adr ); ?></span>
			</a>
			<?php endif; ?>
		</div>
	</div>
