 ...
 * Usage: adn_component( 'parts/calcs_sidebar', array( 'sidebar' => $ctx['sidebar'] ) );
 */
...
?>
<aside class="calcs-sidebar">

	<?php if ( ! empty( $categories ) ) : ?>
		<div class="calcs-sidebar-section">
		...
		<div class="calcs-sidebar-help">
			...
			<?php if ( ! empty( $help['button_label'] ) ) : ?>
				<a
					...
					class="btn btn-primary calcs-help-btn"
				>
