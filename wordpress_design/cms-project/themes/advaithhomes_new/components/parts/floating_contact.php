 ...
 * Numbers come straight from the contact settings table via the
 * COMPANY_WHATSAPP_NO / COMPANY_PHONE_NO constants.
 ...
 * adn_service_contact_data()['contact_sidebar'] (DB-backed contact data), with
 * the global COMPANY_* constants as a fallback.
 */
$_wa_src = '';
$_ph_src = '';
...
<div class="adn-fab" role="complementary" aria-label="<?php esc_attr_e( 'Contact us', ADN_TEXT_DOMAIN ); ?>">
	...
	<?php if ( '' !== $_wa ) : ?>
		<a class="adn-fab-btn adn-fab-wa"
		   ...
		   aria-label="<?php echo esc_attr( SITE_SIDEBAR_WHATSAPP_BTN ); ?>">
			...
			<span class="adn-fab-label"><?php echo esc_html( SITE_SIDEBAR_WHATSAPP_BTN ); ?></span>
		</a>
	<?php endif; ?>
	...
	<?php if ( '' !== $_ph ) : ?>
		<a class="adn-fab-btn adn-fab-call"
		   ...
		   aria-label="<?php echo esc_attr( SITE_SIDEBAR_CONTACT_BTN ); ?>">
			<i class="fa-solid fa-phone" aria-hidden="true"></i>
			<span class="adn-fab-label"><?php echo esc_html( SITE_SIDEBAR_CONTACT_BTN ); ?></span>
		</a>
	<?php endif; ?>
