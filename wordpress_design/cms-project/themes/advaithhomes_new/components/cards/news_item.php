...
<a href="<?php echo esc_url( adn_link( isset( $item['url'] ) ? $item['url'] : '' ) ); ?>" class="news-item">
    ...
    <div class="news-item-content">
        <div class="news-item-title"><?php echo esc_html( isset( $item['title'] ) ? $item['title'] : '' ); ?></div>
        <div class="news-item-meta">
            <span><?php echo esc_html( isset( $item['date'] ) ? $item['date'] : '' ); ?></span>
            <?php if ( ! empty( $item['tag'] ) ) : ?>
                <span class="news-item-tag"><?php echo esc_html( $item['tag'] ); ?></span>
            <?php endif; ?>
        </div>
    </div>
</a>
