<?php
/**
 * components/sections/tools_all.php - All calculators: filter tabs + 2-col list + find-my-calc CTA.
 *
 * Props:
 ...
 *
 * Usage: adn_component( 'sections/tools_all', array( 'filter_tabs' => ..., 'all_tools' => ..., 'find_cta' => ... ) );
 */
