...
if ( ! class_exists( 'AH_Enquiry_Model' ) ) {
	echo '<div class="wrap"><h1>Guidance Submissions</h1><p>Enquiry model not loaded. Ensure the Advaith Homes theme is active.</p></div>';
	return;
}
...
$base_url  = admin_url( 'admin.php?page=ah-guidance' );
