...
$rows      = AH_Enquiry_Model::get_list( 'contact', $filter, $per_page, $offset );
$total     = AH_Enquiry_Model::count( 'contact', $filter );
$all_count = AH_Enquiry_Model::count( 'contact' );
$pages     = $total > 0 ? (int) ceil( $total / $per_page ) : 1;

$base_url  = admin_url( 'admin.php?page=adn-theme-contact-inbox' );
