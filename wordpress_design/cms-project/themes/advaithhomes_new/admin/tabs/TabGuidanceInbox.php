...
<ul class="subsubsub" style="margin-bottom:8px; width: 100%;">
	...
	<li style="float: right;">
		<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin-post.php?action=adn_clear_guidance_inbox' ), 'adn_clear_guidance_inbox' ) ); ?>" class="button button-secondary" onclick="return confirm('Are you sure you want to permanently delete ALL messages in the guidance inbox? This action cannot be undone.');" style="color: #dc3232; border-color: #dc3232;">Clear All Messages</a>
	</li>
</ul>
