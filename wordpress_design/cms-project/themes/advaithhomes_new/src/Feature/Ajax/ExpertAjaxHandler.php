<?php
namespace Adn\Theme\Feature\Ajax;

defined( 'ABSPATH' ) || exit;

class ExpertAjaxHandler {

	public static function fullPageRender(): void {
	...
	public static function contactAjax(): void {
		...
		$subject = '[' . \SITE_BRAND_NAME . '] Enquiry for ' . $expert_name . ' from ' . $sender_name;
	...
	public static function unlockAjax(): void {
