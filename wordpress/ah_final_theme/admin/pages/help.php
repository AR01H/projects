...
<div class="ah-help-hero">
  ...
  <div>
    <h1>Help &amp; Guide</h1>
    <p>Everything you need to know about managing your website with the AH CMS. Pick a topic below to get started.</p>
  </div>
</div>
  ...
  <div class="ah-card" style="padding:24px;">
    ...
    <div class="ah-help-section">
      ...
      <ul>
        ...
        <li>The AH CMS plugin must be active — check <em>Plugins</em> in WordPress admin.</li>
      </ul>
