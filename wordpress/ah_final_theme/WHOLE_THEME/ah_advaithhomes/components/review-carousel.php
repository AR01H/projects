...
$avatars = [ '👩‍💼', '👨‍💼', '👩‍🏫', '👨‍💻', '👩‍🔬', '👨‍🏗️' ];
?>
<section class="section" aria-label="Client success stories">
  <div class="container">
    ...
    <div class="stories-carousel-wrap" data-carousel-wrap data-autoplay="5000">
      ...
      <div class="stories-carousel__detail">
        ...
        <div class="stories-carousel-nav">
          ...
          <span style="font-size:.82rem;color:var(--text-muted);min-width:40px;text-align:center" data-carousel-counter>1 / <?php echo count( $reviews ); ?></span>
