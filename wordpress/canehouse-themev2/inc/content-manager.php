...
add_action('admin_menu', function () {
    ...
    add_submenu_page('ch-content','ℹ️ About Us','ℹ️ About Us','manage_options','ch-about','canehouse_about_page');
    add_submenu_page('ch-content','⭐ Reviews','⭐ Reviews','manage_options','ch-reviews','canehouse_reviews_page');
    add_submenu_page('ch-content','📍 Franchise Locations','📍 Franchise Locations','manage_options','ch-franchise-locs','canehouse_franchise_locs_page');
    add_submenu_page('ch-content','🖼️ Gallery','🖼️ Gallery','manage_options','ch-gallery','canehouse_gallery_page');
    add_submenu_page('ch-content','📞 Contact Us','📞 Contact Us','manage_options','ch-contact','canehouse_contact_page');
    add_submenu_page('ch-content','🎯 Specialities','🎯 Specialities','manage_options','ch-specialities','canehouse_specialities_page');
