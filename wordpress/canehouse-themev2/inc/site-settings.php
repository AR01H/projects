...
function ch_save_options()
{
  if (!isset($_POST['ch_settings_nonce']))
    return;
  if (!wp_verify_nonce($_POST['ch_settings_nonce'], 'ch_save_settings'))
    return;
...
function ch_site_settings_page()
{
  ...
  <div class="wrap">
    ...
    <p style="color:#666;">These settings apply to <strong>every page</strong> — header, footer, contact details
      everywhere.</p>
    <form method="post">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-top:20px;">
        ...
        <div>
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin-bottom:20px;">
            ...
            <table class="form-table" style="margin:0;">
              <tr>
                <th>Phone Number</th>
                <td><input type="text" name="ch_phone" value="<?php echo esc_attr(ch_opt('phone')); ?>"
                    class="regular-text"><br><small>Shown in footer, contact section, franchise</small></td>
              </tr>
              <tr>
                <th>WhatsApp Number<br><small>(digits only)</small></th>
                <td><input type="text" name="ch_whatsapp" value="<?php echo esc_attr(ch_opt('whatsapp')); ?>"
                    class="regular-text"><br><small>e.g. 447887699208 — used for floating WhatsApp button</small></td>
              </tr>
              <tr>
                <th>Email Address</th>
                <td><input type="text" name="ch_email" value="<?php echo esc_attr(ch_opt('email')); ?>"
                    class="regular-text"></td>
              </tr>
              <tr>
                <th>Website URL</th>
                <td><input type="text" name="ch_website" value="<?php echo esc_attr(ch_opt('website')); ?>"
                    class="regular-text"></td>
              </tr>
              <tr>
                <th>Address / Coverage</th>
                <td><textarea name="ch_address" rows="2"
                    class="regular-text"><?php echo esc_textarea(ch_opt('address')); ?></textarea></td>
              </tr>
            </table>
          </div>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin-bottom:20px;">
            ...
            <table class="form-table" style="margin:0;">
              <tr>
                <th>📸 Instagram</th>
                <td><input type="text" name="ch_social_ig" value="<?php echo esc_attr(ch_opt('social_ig')); ?>"
                    class="regular-text"></td>
              </tr>
              <tr>
                <th>📘 Facebook</th>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin-bottom:20px;">
            ...
            <table class="form-table" style="margin:0;">
              <tr>
                <th>Enable Banner</th>
                <td><input type="checkbox" name="ch_header_notice_on" value="1" <?php checked(ch_opt('header_notice_on'), '1'); ?>> Show announcement banner</td>
              </tr>
              <tr>
                <th>Banner Text</th>
        ...
        <div>
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin-bottom:20px;">
            ...
            <table class="form-table" style="margin:0;">
              <tr>
                ...
                <td><input type="text" name="ch_footer_copyright"
                    value="<?php echo esc_attr(ch_opt('footer_copyright')); ?>" class="large-text"></td>
              </tr>
              <tr>
                <th>Footer Description</th>
                <td><textarea name="ch_footer_desc" rows="3"
                    class="large-text"><?php echo esc_textarea(ch_opt('footer_desc')); ?></textarea></td>
              </tr>
              <tr>
                <th>Policy Page Links<br><small>(one per line)</small></th>
                <td><textarea name="ch_footer_policy_links" rows="4"
                    class="large-text"><?php echo esc_textarea(ch_opt('footer_policy_links')); ?></textarea>
                  <br><small>These auto-link to pages with matching titles (Privacy Policy, Terms & Conditions, Refund
                    Policy)</small>
                </td>
              </tr>
            </table>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin-bottom:20px;">
            ...
            <textarea name="ch_maps_embed" rows="4"
              style="width:100%;font-size:11px;"><?php echo esc_textarea(ch_opt('maps_embed')); ?></textarea>
          ...
          <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:20px;">
            ...
            <textarea name="ch_franchise_locations" rows="8"
              style="width:100%;"><?php echo esc_textarea(ch_opt('franchise_locations')); ?></textarea>
